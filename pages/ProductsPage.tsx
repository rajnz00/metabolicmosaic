...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => (
    <div className="group relative">
        ...
        <button
            ...
            className="mt-4 w-full bg-brand-primary text-white py-2 px-4 rounded-md font-semibold hover:bg-brand-secondary transition-colors opacity-0 group-hover:opacity-100"
        >
            Add to cart
        </button>
    </div>
