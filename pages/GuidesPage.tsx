...
const GuideCard: React.FC<{ guide: Guide }> = ({ guide }) => (
  <div className="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
    ...
    <button
        onClick={() => alert(`Redirecting to checkout for ${guide.name}...`)}
        className="w-full bg-brand-primary text-white py-2 px-4 font-semibold hover:bg-brand-secondary transition-colors"
    >
        Buy Now
    </button>
  </div>
